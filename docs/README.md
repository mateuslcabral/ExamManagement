...
| [`07-roadmap/`](07-roadmap/) | Situação atual dos módulos e ordem sugerida do que falta. |
| [`para-rafael.md`](para-rafael.md) | Todas as decisões tomadas na implementação, dúvidas e dilemas, consolidadas para validação. |
