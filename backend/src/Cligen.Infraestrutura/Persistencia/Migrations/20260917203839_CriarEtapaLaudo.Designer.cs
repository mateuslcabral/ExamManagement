...
namespace Cligen.Infraestrutura.Persistencia.Migrations
{
    ...
    [Migration("20260917203839_CriarEtapaLaudo")]
    partial class CriarEtapaLaudo
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Cligen.Dominio.Entidades.Exame", b =>
                {
                    ...
                    b.OwnsMany("Cligen.Dominio.Entidades.EtapaAndamento", "Etapas", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .HasColumnType("uniqueidentifier");
                            ...
                            b1.Property<int>("Substituicoes")
                                .HasColumnType("int");

                            b1.Property<DateTime?>("SubstituidoEm")
                                .HasColumnType("datetime2");

                            b1.Property<Guid?>("SubstituidoPorId")
                                .HasColumnType("uniqueidentifier");
                            ...
                            b1.HasIndex("SubstituidoPorId");

                            b1.HasIndex("ExameId", "Tipo")
                                .IsUnique();

                            b1.ToTable("EtapaAndamento", (string)null);
